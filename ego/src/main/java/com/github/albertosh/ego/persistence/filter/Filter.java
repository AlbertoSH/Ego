...
import static com.github.albertosh.ego.persistence.filter.IFilterField.ID_KEY;

public class Filter<T extends EgoObject> {
    ...
    private Object transformObjectIfNecessary(String field, Object value) {
        if (value == null) {
            ...
            if ((field.toLowerCase().endsWith(ID_KEY))
